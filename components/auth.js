...
let signUpBox = ()=>{
    ...
    <div class="broking_part mx-3 w-5/5 items-center flex">
    ...
    <h1 class="text-base font-semibold mx-3 mt-1">Sign up</h1>
    <p class="mx-3 text-small">Or check your application status</p>
    <input id="inp_name_signup" type="text" class="inpSignup mt-1 w-5/5 mx-3 mb-3 w-5/5 border-2 rounded border:bg-gray-800" placeholder="UserName">
    <input id="inp_email_signup" type="text" class="inpSignup w-5/5 mx-3 mb-3 w-5/5 border-2 rounded border:bg-gray-800" placeholder="Email">
    <input id="inp_pass_signup" type="text" class="inpSignup w-5/5 mx-3 mb-3 w-5/5 border-2 rounded border:bg-gray-800" placeholder="Password">
...
let displayLogin = backCont=> {
        ...
        try{
            ...
            res.forEach(element => {
                ...
                if(email===mail && pass===Password){
                    // window.location.href = "allsmallcase.html";
                    // write the dashboard location 
                    window.location.href = "allsmallcase.html";
                    flagUserExist = true;
                }
            });
    ...
    function appendLoginOpt(){
        ...
        head.classList.add('font-semibold','text-exsm','text-blue-600');
        ...
        inp_email_log.setAttribute('class','inpInLogin border border:gray-600 px-2 m-2 rounded text-small');
        ...
        inp_pass_log.setAttribute('class','inpInLogin border border:gray-600 px-2 m-2 rounded text-small');
        ...
        btnSubmit.setAttribute('class','bg-blue-600 mb-2 rounded text-white px-2 py-1 block m-auto text-small font-bold');
